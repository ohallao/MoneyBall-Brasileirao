...
if uploaded_file is not None:
    ...
    if len(jogadores_selecionados) > 0:
        ...
        colunas_disponiveis = list(jogadores_filtrados.columns)
        ...
        tabela_metricas = jogadores_filtrados[jogadores_filtrados['jogador'].isin(jogadores_selecionados)][colunas_selecionadas]
